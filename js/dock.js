...
(function () {
    ...
    window.initMagicDock = function () {
        ...
        const updateActiveState = () => {
            const sections = ['about', 'skills', 'projects', 'achievements', 'resume', 'contact'];
            let current = "";
            ...
            items.forEach(item => {
                ...
                // Check if the item's onclick attribute or data-label leads to the current section
                const onclickStr = item.getAttribute('onclick') || '';
                if (onclickStr.includes("'" + current + "'")) {
